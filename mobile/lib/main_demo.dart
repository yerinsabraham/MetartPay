...
Future<void> main() async {
  ...
  final shouldUseEmulator = baseUrl.contains('127.0.0.1') || baseUrl.contains('10.0.2.2') || const bool.fromEnvironment('FORCE_FIRESTORE_EMULATOR', defaultValue: false);
...
class DemoApp extends StatelessWidget {
  ...
  const DemoApp({Key? key, required this.baseUrl}) : super(key: key);
